...
`;
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-4 w-full max-w-4xl text-content">
      <div className="flex flex-col justify-center gap-4 w-full bg-tab-panel rounded-lg border border-border p-4 shadow-lg">

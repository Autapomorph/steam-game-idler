...
import type { GlobalSettings, UserSettings } from '@/shared/api';
...
const settingsSlice: StateCreator<
...
export const useSettings = create<SettingsState & SettingsActions>()(settingsSlice);
